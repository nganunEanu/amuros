...
//  }
  ...
  if(y!=0 && thet==0 || x!=0 && thet==0 || y!=0 && x!=0 && thet==0 || y==0 && x==0 && thet==0 ){kinematik(ux, uy, 0, speedd);
...
//      if (job == 1)conjob =1;
  ...
  if(y==0 && thet!=0 || x==0 && thet!=0 || y==0 && x==0 && thet!=0 || y!=0 && x!=0 && thet!=0 ){kinematik(0, 0, uthet, speedd);
