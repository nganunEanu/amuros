...
int posseb[] = {0,0,0};
float  c_rpm[]= {0,0,0};
const float ppr[] = {135.0 ,137.0 ,135.0};
int target[] = {0,0,0};
//#define m1 1
//#define m2 2
//#define m3 3
...
int variableSpeed, variableSpeedPos;
...
//          } 
//          kinematik(300,0,0,0.3);
        if(dones==0)PIDpos(1000, 0, 90, 0.3);
        if(dones==1)PIDpos(1000, 500, 0, 1);
        if(dones==2)PIDpos(0, 0, 90, 1);
...
int perhitungan = variableSpeed - variableSpeedPos;
int variablePersen = map(perhitungan,0,variableSpeed,70,40);
//spd = (spd * variablePersen)/100;
Serial.print(" = ");
Serial.print(variableSpeed);
Serial.print(" = ");
Serial.print(variableSpeedPos);
Serial.print(" = ");
Serial.print(perhitungan);
Serial.print(" = ");
Serial.print(variablePersen);
Serial.print(" = ");
Serial.println(spd);
...
void PIDpos(int y,int x, int thet, float speedd){
  float tt1 = ((((thet * 1256)/120)*3)*0.7);
  float tt2 = ((((Thet * 1256)/120)*3)*0.7);
  variableSpeed = (abs(x) + abs(y)) / 3;
  variableSpeedPos = (abs(Xpos) + abs(Ypos)) / 3;
  float kpP = 0.07;
