...
void loop() {
  ...
  if(mil1 - milseb11 >=500){
    int back = digitalRead(11);
    
    if(back==0){counting = counting + 1;}
    if(counting == 3){delay(1000);}
    if(counting > 3){PIDpos(0, 0, 0, 0.6);}
    if(back==1){counting = 0;}
      ///////////-------------------------------------KINEMATIKA-----------------------
