...
void Odometry(){
      ...
      double vv1 = (0.7*Kanan);
      double vv2 = -(0.7*Kanan);
      double vv3 =  (0.7*Kiri);
      double vv4 = -(0.7*Kiri);

      double vvv1= (cos(degree(f))*vv1)+(-sin(degree(f))*vv2);
      double vvv2= (cos(degree(f))*vv4)+(-sin(degree(f))*vv4);
      double vvv3= (sin(degree(f))*vv1)+(cos(degree(f))*vv2);
      double vvv4= (sin(degree(f))*vv4)+(cos(degree(f))*vv4);
      ...
      float ypos = vvv1+vvv3;
      float xpos = vvv2+vvv4; 
